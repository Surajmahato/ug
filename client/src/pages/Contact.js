                        ...
                        <div className="contact-information">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <span className="text"><span> Kandevtasthan, Laltipur, Nepal</span></span>
                                </li>
                                <li>
                                    <span className="icon"><i className="ion-ios-telephone-outline" /></span>
                                    <span className="text"><a href="tel:1234567890">(+977)15181033</a><a href="tel:1234567890">(001) 65897 569 784</a></span>
                                </li>
                                <li>
                                    <span className="icon"><i className="ion-ios-email-outline" /></span>
                                    <span className="text"><a href="mailto:info@example.com">connect@patancollege.org</a><a href="mailto:info@example.com">info@example.com</a></span>
                                </li>
                            </ul>
                        </div>
                        </div>
